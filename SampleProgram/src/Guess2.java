...
public class Guess2 {
	...
	public static void main(String[] args) {
		...
		int userguess = 0;				// user's guess,  1 - 6 inclusive
		int rolled = 0;				// number rolled, 1 - 6 inclusive
		...
		int numGuesses = 1;				// counts the number of guesses per round
		...
		for (int r = 0; r <= 5; r++) {
			...
			System.out.println(rolled+"The computer has rolled the die.");
